'''
Functions to retrieve figures based on figure labels (e.g., 'Fig. 1', 'Scheme 2', 'Figure 3', etc.) from html/xml files.
Publisher supported: RSC, Elsevier, ACS, Wiley, Springer, Nature, Science, Taylor and Francis, MDPI
'''
